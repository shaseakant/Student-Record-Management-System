...
<ul>
  ...
  <li><a href="menu_items.php"><i class="fas fa-pizza-slice"></i> Menu Items</a></li>
  <li><a href="stocks.php"><i class="fas fa-boxes"></i> Stocks</a></li>
  ...
  <li><a href="report.php"><i class="fas fa-money-bill-wave"></i> Reports</a></li>
</ul>
